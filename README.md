...
This repository contains benchmarks for [Crossmint](https://www.crossmint.com/), a platform for building web3 applications.

You can view the evaluation reports at [crossmint-benchmark](https://desu-club.github.io/crossmint-benchmark/).
